...
1. Read `../../methods/technical-reasoning.md` and `../../methods/architecture-reasoning.md`. Apply both methods inside this workflow.
...
8. Read `../../methods/prose-quality.md`, then use `assets/technical-architecture-template.md`. Link System Profiles and detailed System Architecture rather than copying their design.
