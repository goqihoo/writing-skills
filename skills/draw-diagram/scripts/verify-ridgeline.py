...
Usage:
    python3 skills/draw-diagram/scripts/verify-ridgeline.py --all
    python3 skills/draw-diagram/scripts/verify-ridgeline.py skills/draw-diagram/assets/examples/example-ridgeline.html
