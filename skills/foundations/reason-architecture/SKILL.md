...
description: Apply the shared architecture reasoning method for domain facts, application ownership and contracts, governance authority and evidence, runtime failure and recovery, control traces, tradeoffs, and validation. Use when reasoning about software architecture, and whenever study-architecture or design-architecture needs the common method.
---
