# Technical Documentation Inventory: [Company]

## Scope and authority

- Requested action: [proposal / scaffold / audit / approved migration]
- Company and Technical authority:
- Technical Assessment, when persisted:
- Allowed changes:
...
| Material | Competing owners | Primary owner | Link or split | Reason |
| --- | --- | --- | --- | --- |
| | | | | |
