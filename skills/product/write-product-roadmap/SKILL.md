---
name: write-product-roadmap
description: Create, revise, or review an evidence-backed product roadmap that sequences outcomes, product bets, capability gaps, dependencies, commitments, confidence, decision gates, and review triggers without becoming a feature calendar or task backlog.
disable-model-invocation: true
---

# Write Product Roadmap

Translate strategy and evidence into an explicit sequence of product outcomes and learning decisions.
...
The work is complete when the horizon and commitment semantics are clear, every item traces to strategy or evidence, outcomes are distinct from features and tasks, dependencies and decision gates explain sequence, confidence matches evidence, explicit exclusions prevent false promises, and review triggers show how the roadmap changes.
