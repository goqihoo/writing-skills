...
- **Purposeful enumeration.** State the conclusion or shared category before its examples. Use a full enumeration only when the reader must distinguish, compare, verify, or act on every item; otherwise group items by meaning and keep the smallest representative set that preserves the conclusion. Keep peer items at one level of abstraction, and move a necessary long checklist out of prose.
