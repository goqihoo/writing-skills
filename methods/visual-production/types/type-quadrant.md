...
- `../../../skills/draw-diagram/assets/examples/example-quadrant.html`
...
- **Axis lines**: `ink` (`#22263A`), `stroke-width: 1.2`, `marker-start` + `marker-end` both pointing outward.
- **Focal quadrant tint**: `rgba(79,91,213,0.04)` full rect behind the focal cell.
