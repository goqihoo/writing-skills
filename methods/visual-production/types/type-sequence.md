...
<marker id="arrow-open" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto">
  <polyline points="0 0, 8 3, 0 6" fill="none" stroke="#596174" stroke-width="1.2"/>
</marker>
```

Dark mode: stroke `#CBD2DF` (muted on dark paper). Do not fill the open marker — the hollow head is the async signal. Return messages keep the **filled** marker even when dashed.
...
<rect x="X" y="Y" width="W" height="H" rx="4"
      fill="rgba(34,38,58,0.02)" stroke="rgba(34,38,58,0.22)" stroke-width="1"/>
<!-- Operator tab -->
<rect x="X" y="Y" width="40" height="16" rx="2"
      fill="#FFFFFF" stroke="rgba(34,38,58,0.22)" stroke-width="1"/>
<text x="X+20" y="Y+12" fill="#596174" font-size="8"
      font-family="'Geist Mono', monospace" text-anchor="middle"
      letter-spacing="0.12em">ALT</text>
```

Dark mode: frame fill `rgba(255,255,255,0.04)`, stroke `rgba(255,255,255,0.22)`, tab fill = dark `paper` (`#22263A`), tab text = dark `muted` (`#CBD2DF`).
...
- Max lifelines: 5 (same as ../svg-guide.md `Layout and complexity`).
...
<line x1="CX" y1="TOP" x2="CX" y2="BOTTOM"
      stroke="rgba(34,38,58,0.20)" stroke-width="1" stroke-dasharray="3,3"/>
```

## Activation bar primitive
```svg
<rect x="CX-4" y="TOP" width="8" height="H"
      fill="rgba(34,38,58,0.06)" stroke="#596174" stroke-width="0.8"/>
```
...
- `../../../skills/draw-diagram/assets/examples/example-sequence.html`
