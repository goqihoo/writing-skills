...
class StructureDomainDocsContractTest(unittest.TestCase):
    def test_skill_owns_domain_specific_structure(self) -> None:
        ...
        self.assertIn("methods/documentation-structure.md", skill)
        ...
        self.assertIn("without drafting the README body", skill)
        self.assertIn("`$Write Domain Doc` owns the README body", skill)
