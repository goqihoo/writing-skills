...
Usage:
    python3 skills/draw-diagram/scripts/verify-slopegraph.py --all
    python3 skills/draw-diagram/scripts/verify-slopegraph.py skills/draw-diagram/assets/examples/example-slopegraph.html
