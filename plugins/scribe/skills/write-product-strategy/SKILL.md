...
description: Create, revise, or review a product strategy that defines target users, value, product boundary, positioning, strategic choices, non-goals, capability implications, outcomes, assumptions, and review triggers.
---

# Write Product Strategy

Produce an evidence-backed product strategy that makes durable choices without becoming a roadmap or feature list.
...
The work is complete when evidence supports or qualifies the target users and problem, value and positioning are distinct, choices and non-goals constrain action, capability implications follow from the strategy, outcomes can be evaluated, accepted costs and assumptions are visible, and review triggers identify when the strategy must change.
