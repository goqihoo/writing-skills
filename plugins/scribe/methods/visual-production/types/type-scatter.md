...
**Area encodes the third value — never radius.** Radius-proportional sizing squares the claim: a 6× value reads as 36× the ink. `../../../skills/draw-diagram/scripts/verify-bubble.py` gates it, along with the two axis scales.
