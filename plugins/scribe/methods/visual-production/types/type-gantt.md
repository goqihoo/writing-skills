...
- **Phase grouping:** a subtle zone rect (same pattern as architecture zone) behind each phase's rows, with an eyebrow label in the top-left margin. Use `rgba(34,38,58,0.02)` fill, `rgba(34,38,58,0.10)` stroke.
...
<rect x="X_start" y="ROW_Y+8" width="DURATION_PX" height="24" rx="4"
      fill="rgba(89,97,116,0.15)" stroke="#596174" stroke-width="1"/>
<text x="X_start+8" y="ROW_Y+25" fill="#22263A" font-size="10" font-weight="600"
      font-family="'Geist', sans-serif">Task name</text>

<!-- Focal task -->
<rect x="X_start" y="ROW_Y+8" width="DURATION_PX" height="24" rx="4"
      fill="rgba(79,91,213,0.12)" stroke="#4F5BD5" stroke-width="1"/>
<text x="X_start+8" y="ROW_Y+25" fill="#4F5BD5" font-size="10" font-weight="600"
...
- `../../../skills/draw-diagram/assets/examples/example-gantt.html`
