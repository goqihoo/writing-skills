...
The Diagram Design source is MIT-licensed (see [`DIAGRAM_DESIGN_LICENSE.txt`](DIAGRAM_DESIGN_LICENSE.txt)). It bundles content from the following third-party sources, redistributed under their respective licenses.
