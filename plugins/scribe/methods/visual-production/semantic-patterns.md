...
- Optional animation is a presentation layer, not another pattern. Static output is the bundled contract; use a separate explicitly requested production contract when motion is required.
