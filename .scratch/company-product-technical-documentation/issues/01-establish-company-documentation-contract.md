...
- [ ] Knowledge 被定义为不绑定特定公司的通用知识，并可按 Domain、Product、Technical、Architecture 等主题组织。
- [ ] Product Documentation 与 Technical Documentation 被定义为一家特定公司拥有和维护的 Company Documentation。
- [ ] Project Documentation 保持独立权威范围，Delivery 与 Coordination 不成为内容类别或技能桶。
- [ ] 公司根目录可以导航 Product 与 Technical，并允许二者独立物化；公司文档目录使用首字母大写。
- [ ] Stable Responsibility、Type Extension 与 Event Collection 的创建条件具有唯一、可检查的定义。
